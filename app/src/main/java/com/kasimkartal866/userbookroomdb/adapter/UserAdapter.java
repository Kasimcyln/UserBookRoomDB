package com.kasimkartal866.userbookroomdb.adapter;
...
import com.kasimkartal866.userbookroomdb.activities.G;
import com.kasimkartal866.userbookroomdb.activities.UserActivity;
import com.kasimkartal866.userbookroomdb.databinding.RecyclerRowBinding;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.binding.recyclerViewTextView.setText(user.getFName());
